...
class Command:
    ...
    def __init__(self,
        ...
        - initialize (`Callable[[object], None]`): What to do on command triggered.

        - execute (`Callable[[object], None]`): What to do while the command is still active.

        - is_finished (`Callable[[object], bool]`): Return True if the command is done. Checked before each call to execute.

        - end (`Callable[[object, bool], None]`): How to react to the command ending. Has a flag to indicate whether or not the command was interrupted.
        """
    ...
    def is_finished(self):
        """ Return True if the command is done. Checked before each call to execute. """
    ...
    def is_running(self):
        """ Return whether or not the command is active. """
